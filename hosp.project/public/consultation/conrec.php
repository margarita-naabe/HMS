...
$updatequery = " UPDATE `hospital_management`.`daily_patients_interactions` SET  admitted =$admitted,lab =$lab, pharm =$pharm WHERE daily_patients_interactions.patients_id=$patients_id";
